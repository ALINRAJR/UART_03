...
void vPinmuxInitialize(void)
{
	...
	/* Setting UART0 functionality for selected pins */
	vPinmuxSel(UARTPins[0].GPIOx, UARTPins[0].pin, UARTPins[0].func); //TXD0
	vPinmuxSel(UARTPins[1].GPIOx, UARTPins[1].pin, UARTPins[1].func); //RXD0
	/* Setting UART1 functionality for selected pins */
	vPinmuxSel(UARTPins[2].GPIOx, UARTPins[2].pin, UARTPins[2].func); //TXD1
	vPinmuxSel(UARTPins[3].GPIOx, UARTPins[3].pin, UARTPins[3].func); //RXD1
	/* Setting UART2 functionality for selected pins */
	vPinmuxSel(UARTPins[4].GPIOx, UARTPins[4].pin, UARTPins[4].func); //TXD2
	vPinmuxSel(UARTPins[5].GPIOx, UARTPins[5].pin, UARTPins[5].func); //RXD2
	/* Setting UART3 functionality for selected pins */
	vPinmuxSel(UARTPins[6].GPIOx, UARTPins[6].pin, UARTPins[6].func); //TXD3
	vPinmuxSel(UARTPins[7].GPIOx, UARTPins[7].pin, UARTPins[7].func); //RXD3
